...
exports.LocationModule = LocationModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([user_location_entity_1.UserLocation, background_check_entity_1.BackgroundCheck])
        ],
        controllers: [location_controller_1.LocationController],
        providers: [location_service_1.LocationService, background_check_service_1.BackgroundCheckService],
        exports: [location_service_1.LocationService, background_check_service_1.BackgroundCheckService],
    })
], LocationModule);
